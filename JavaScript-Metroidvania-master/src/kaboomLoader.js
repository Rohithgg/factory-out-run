...
k.loadSprite("player", "./assets/sprites/u.png", {
  ...
  anims: {
    ...
    jump: { from: 58, to: 58, loop: true },
    fall: { from: 54, to: 54, loop: true },
    explode: { from: 64, to: 69 },
    attack: { from: 16, to: 20, speed: 16 },
  },
});
...
k.loadSprite("marksman", "./assets/sprites/m2rksman.png", {
  sliceX: 8,
  sliceY: 6,
  anims: {
    idle: { from: 0, to: 3, loop: true },
    run: { from: 8, to: 11, loop: true },
    "open-fire": { from: 16, to: 20 },
    fire: { from: 24, to: 31, loop: true },
    "shut-fire": { from: 32, to: 39 },
    explode: { from: 40, to: 45 },
  },
});
...
k.loadSound("marksman", "./assets/sounds/marksman.mp3");
k.loadSound("marksman2", "./assets/sounds/maksman2.mp3");
